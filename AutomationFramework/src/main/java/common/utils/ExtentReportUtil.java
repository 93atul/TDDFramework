...
public class ExtentReportUtil extends TestListenerAdapter implements ISuiteListener {
    ...
    public void onTestStart(ITestResult result) {
        ...
        try {
            String ssPath = System.getProperty("user.dir") + File.separator + "screenshots" + File.separator + testCaseName;
    ...
    public void onTestSuccess(ITestResult result) {
        ...
        try {
            CreatePdf.createConsolidatedPDF(getScreenshotPath(), testCaseNames.get());
        }catch(Exception ex){}
    }
    @Override
