...
public class DataProviderUtils {
    @DataProvider(parallel = true,name = "DataProvider_web")
    public Object[][] dataProvider_web(Method m){
        String fileName = System.getProperty("user.dir")+"/src/main/resources/data/DataSheet_web.xlsx";
        String sheetName = "Data";
        Object[][] data = getExcelData(fileName,sheetName,m.getName());
        return data;
    }
    @DataProvider(parallel = true,name = "DataProvider_api")
    public Object[][] dataProvider_api(Method m){
        String fileName = "DataSheet_api.xlsx";
        String sheetName = "Data";
        Object[][] data = getExcelData(fileName,sheetName,m.getName());
        return data;
    }
